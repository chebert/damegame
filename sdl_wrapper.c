...
DLL_EXPORT SDL_Texture* LoadBMP(char* path);
DLL_EXPORT SDL_Texture* LoadBMPWithColorKey(char* path, u8 r, u8 g, u8 b);
DLL_EXPORT SDL_Texture* FreeTexture(SDL_Texture* texture);
DLL_EXPORT int TextureWidth(SDL_Texture* texture);
DLL_EXPORT int TextureHeight(SDL_Texture* texture);
DLL_EXPORT TTF_Font* OpenFont(char* path, int point_size);
DLL_EXPORT void CloseFont(TTF_Font* font);
DLL_EXPORT SDL_Texture* CreateTextTexture(TTF_Font* font, char* text);
