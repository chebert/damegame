  ...
  (let* ((imm8? (or (member into-key '(:imm8 :@imm8))
    ...
    (merge-instr-specs
     (instr-spec-defaults :opcode opcode
			  :cycles cycles)
     (when imm8?
       (imm8-instr-spec  :imm8-name imm8-name))
     (when imm16?
       (imm16-instr-spec :imm16-name imm16-name))
